...
For the next step we have to select a distance friction function. `plot_inter()` allows to visualize the decrease of the interaction density with the distance according to the selected function and its parameters. 
...
```{r smooth, fig.path="./", fig.width = 7, fig.height= 6, results=FALSE, eval = F}
